...
m_ble_service_handles:
	.space	40
	.global	impactID
	.section	.bss.impactID,"aw",%nobits
	.align	2
	.type	impactID, %object
	.size	impactID, 4
impactID:
	.space	4
	.section .rodata
...
.LBB22:
	...
	cmp	r3, #0
	beq	.L144
	.loc 11 143 5 is_stmt 0 discriminator 1
	ldr	r2, .L150+4
	movs	r1, #143
	ldr	r0, [sp, #4]
	bl	app_error_handler
...
.LBB23:
	...
	cmp	r3, #0
	beq	.L149
	.loc 11 160 13 is_stmt 0 discriminator 1
	ldr	r2, .L150+4
	movs	r1, #160
	ldr	r0, [sp]
	bl	app_error_handler
.LBE23:
	.loc 11 175 1 is_stmt 1 discriminator 1
	b	.L149
.L145:
	.loc 11 164 13 discriminator 1
	ldr	r1, .L150+12
	movs	r0, #2
	bl	nrf_log_frontend_std_0
.L148:
	.loc 11 167 18 discriminator 1
	b	.L148
.L149:
	.loc 11 175 1
	nop
...
.LBB30:
	...
	cmp	r3, #0
	beq	.L156
	.loc 11 188 5 is_stmt 0 discriminator 1
	ldr	r2, .L157
	movs	r1, #188
	ldr	r0, [sp, #16]
	bl	app_error_handler
...
.LBB32:
	...
	cmp	r3, #0
	beq	.L161
	.loc 11 206 13 is_stmt 0 discriminator 1
	ldr	r2, .L166+4
	movs	r1, #206
	ldr	r0, [sp, #24]
	bl	app_error_handler
...
.LBB33:
	...
	cmp	r3, #0
	beq	.L165
	.loc 11 219 21 is_stmt 0 discriminator 1
	ldr	r2, .L166+4
	movs	r1, #219
	ldr	r0, [sp, #20]
	bl	app_error_handler
.LBE33:
.LBE31:
	.loc 11 235 1 is_stmt 1 discriminator 1
	b	.L165
.L162:
.LBB34:
	.loc 11 223 21 discriminator 1
	ldr	r1, .L166+12
	movs	r0, #2
	bl	nrf_log_frontend_std_0
.L164:
	.loc 11 225 26 discriminator 1
	b	.L164
.L165:
.LBE34:
	.loc 11 235 1
...
.L172:
	...
	movs	r0, #3
	bl	nrf_log_frontend_std_0
	.loc 11 251 13 discriminator 1
	movs	r0, #5
	bl	nrf_delay_ms
	.loc 11 252 13 discriminator 1
	bl	NVIC_SystemReset
...
.L173:
	...
	movs	r0, #3
	bl	nrf_log_frontend_std_0
	.loc 11 258 13 discriminator 1
	bl	NVIC_SystemReset
	.loc 11 259 13 discriminator 1
	nop
.L171:
.L174:
	.loc 11 261 1
...
.LBB35:
	...
	cmp	r3, #0
	beq	.L178
	.loc 11 277 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	movw	r1, #277
	ldr	r0, [sp, #96]
	bl	app_error_handler
...
.LBB36:
	...
	cmp	r3, #0
	beq	.L179
	.loc 11 283 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	movw	r1, #283
	ldr	r0, [sp, #92]
	bl	app_error_handler
...
.LBB37:
	...
	cmp	r3, #0
	beq	.L180
	.loc 11 289 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	movw	r1, #289
	ldr	r0, [sp, #88]
	bl	app_error_handler
...
.LBB39:
	...
	cmp	r3, #0
	beq	.L182
	.loc 11 299 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	movw	r1, #299
	ldr	r0, [sp, #80]
	bl	app_error_handler
...
.LBB41:
	...
	cmp	r3, #0
	beq	.L184
	.loc 11 307 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	movw	r1, #307
	ldr	r0, [sp, #72]
	bl	app_error_handler
...
.LBB43:
	...
	cmp	r3, #0
	beq	.L187
	.loc 11 318 5 is_stmt 0 discriminator 1
	ldr	r2, .L188+12
	mov	r1, #318
	ldr	r0, [sp, #64]
	bl	app_error_handler
...
.LBB44:
	...
	cmp	r3, #0
	beq	.L191
	.loc 11 353 5 is_stmt 0 discriminator 1
	ldr	r2, .L192+4
	movw	r1, #353
	ldr	r0, [sp, #8]
	bl	app_error_handler
...
.LBB45:
	...
	cmp	r3, #0
	beq	.L195
	.loc 11 376 5 is_stmt 0 discriminator 1
	ldr	r2, .L198+8
	mov	r1, #376
	ldr	r0, [sp, #24]
	bl	app_error_handler
...
.LBB47:
	...
	cmp	r3, #0
	beq	.L197
	.loc 11 385 5 is_stmt 0 discriminator 1
	ldr	r2, .L198+8
	movw	r1, #385
	ldr	r0, [sp, #16]
	bl	app_error_handler
...
.L198:
	.word	m_twi_sensors
	.word	twi_config.12021
	.word	.LC3
.LFE375:
	.size	shield_init, .-shield_init
	.section	.text.in_pin_handler,"ax",%progbits
	.align	1
	.global	in_pin_handler
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	in_pin_handler, %function
in_pin_handler:
.LFB376:
	.loc 11 392 1
	@ args = 0, pretend = 0, frame = 8
...
.L201:
	.word	impactID
.LFE376:
	.size	in_pin_handler, .-in_pin_handler
	.section .rodata
	.align	2
.LC0:
	.byte	3
...
.LBB48:
	...
	cmp	r3, #0
	beq	.L204
	.loc 11 411 5 is_stmt 0 discriminator 1
	ldr	r2, .L205+8
	movw	r1, #411
	ldr	r0, [sp, #8]
	bl	app_error_handler
...
.LBB49:
	...
	cmp	r3, #0
	beq	.L213
	.loc 11 430 5 is_stmt 0 discriminator 1
	ldr	r2, .L214
	mov	r1, #430
	ldr	r0, [sp, #16]
	bl	app_error_handler
.L213:
.LBE49:
	.loc 11 433 5 is_stmt 1 discriminator 1
	ldr	r1, .L214+4
	movs	r0, #3
	bl	nrf_log_frontend_std_0
.LBB50:
	.loc 11 436 5 discriminator 1
	ldr	r2, .L214+8
	movs	r1, #60
	movs	r0, #8
	bl	app_sched_init
...
.LBB52:
	...
	cmp	r3, #0
	beq	.L210
	.loc 11 438 5 is_stmt 0 discriminator 1
	ldr	r2, .L214
	mov	r1, #438
	ldr	r0, [sp, #4]
	bl	app_error_handler
...
.LBB53:
	...
	cmp	r3, #0
	beq	.L211
	.loc 11 451 5 is_stmt 0 discriminator 1
	ldr	r2, .L214
	movw	r1, #451
	ldr	r0, [sp]
	bl	app_error_handler
...
.L214:
	.word	.LC3
	.word	.LC11
	.word	APP_SCHED_BUF.12042
.LFE378:
	.size	main, .-main
	.section	.rodata.sx1509_cfg.12013,"a"
	.align	2
	.type	sx1509_cfg.12013, %object
	.size	sx1509_cfg.12013, 12
sx1509_cfg.12013:
	.byte	62
	.space	3
	.word	m_twi_sensors
	.word	twi_config.12012
	.section	.rodata.twi_config.12012,"a"
	.align	2
	.type	twi_config.12012, %object
	.size	twi_config.12012, 16
twi_config.12012:
	.word	8
	.word	7
	.word	107479040
	.byte	6
	.space	3
	.section	.rodata.twi_config.12021,"a"
	.align	2
	.type	twi_config.12021, %object
	.size	twi_config.12021, 16
twi_config.12021:
	.word	15
	.word	14
	.word	107479040
	.byte	6
	.space	3
	.section	.bss.APP_SCHED_BUF.12042,"aw",%nobits
	.align	2
	.type	APP_SCHED_BUF.12042, %object
	.size	APP_SCHED_BUF.12042, 976
APP_SCHED_BUF.12042:
	.space	976
...
.Letext0:
	...
	.file 21 "../../../sdk_components/libraries/util/sdk_errors.h"
	.file 22 "../../../sdk_components/libraries/util/app_error.h"
	.file 23 "../../../sdk_components/softdevice/s132/headers/nrf_nvic.h"
	.file 24 "../../../sdk_components/libraries/util/app_util_platform.h"
	.file 25 "../../../include/modules/m_ble.h"
	.file 26 "../../../sdk_components/drivers_nrf/hal/nrf_twi.h"
	.file 27 "../../../sdk_components/drivers_nrf/twi_master/nrf_drv_twi.h"
	.file 28 "../../../include/modules/m_environment.h"
	.file 29 "../../../include/modules/m_motion.h"
	.file 30 "../../../include/modules/m_ui.h"
	.file 31 "../../../sdk_components/drivers_nrf/hal/nrf_saadc.h"
	.file 32 "../../../include/modules/m_batt_meas.h"
	.file 33 "../../../include/drivers/drv_sx1509.h"
	.file 34 "../../../sdk_components/libraries/timer/app_timer.h"
	.file 35 "../../../include/drivers/drv_ext_light.h"
	.file 36 "../../../include/drivers/drv_ext_gpio.h"
	.file 37 "../../../include/board/pca20020.h"
	.file 38 "../../../sdk_components/drivers_nrf/hal/nrf_gpiote.h"
	.file 39 "../../../sdk_components/drivers_nrf/gpiote/nrf_drv_gpiote.h"
	.file 40 "./drv_ADG728.h"
	.file 41 "./drv_AD5245.h"
...
.Ldebug_abbrev0:
	...
	.ascii	"main\000"
	.4byte	0x471a
	.ascii	"drv_acc_impact_prepare\000"
	.4byte	0x47df
	.ascii	"gpio_init\000"
	.4byte	0x4831
	.ascii	"in_pin_handler\000"
	.4byte	0x4868
	.ascii	"impact_handler_from_main\000"
	.4byte	0x4878

...
.LFE256:
	...
	.section	.bss.m_ADG728,"aw",%nobits
	.align	2
	.type	m_ADG728, %object
	.size	m_ADG728, 12
m_ADG728:
	.space	12
	.section .rodata
...
.LC0:
	...
	.ascii	"ect\\pca20020_s132-XpertRide_v2\\0827.ses\\drv_ADG7"
	.ascii	"28.c\000"
...
twi_open:
.LFB271:
	.file 2 "C:\\Nordic\\SDK\\Nordic-Thingy52-FW-XpertRide\\project\\pca20020_s132-XpertRide_v2\\0827.ses\\drv_ADG728.c"
	.loc 2 35 1
...
.LFE272:
	...
	.section	.text.drv_ADG728_init,"ax",%progbits
	.align	1
	.global	drv_ADG728_init
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	drv_ADG728_init, %function
drv_ADG728_init:
.LFB273:
	.loc 2 78 1
	@ args = 0, pretend = 0, frame = 8
...
.LCFI4:
	...
	cmp	r3, #0
	bne	.L53
	.loc 2 79 5 is_stmt 0 discriminator 1
	movs	r3, #14
	b	.L54
.L53:
	.loc 2 81 44 is_stmt 1
	ldr	r3, [sp, #4]
	ldr	r3, [r3, #4]
	.loc 2 81 34
	ldr	r2, .L55
...
.L55:
	.word	m_ADG728
.LFE273:
	.size	drv_ADG728_init, .-drv_ADG728_init
	.section .rodata
	.align	2
.LC1:
	.ascii	"\033[1;31mdrv_ADG728   :ERROR:drv_ADG728_write Fail"
	.ascii	"ed!\015\012\000"
	.section	.text.drv_ADG728_write,"ax",%progbits
	.align	1
	.global	drv_ADG728_write
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	drv_ADG728_write, %function
drv_ADG728_write:
.LFB274:
	.loc 2 98 1
...
.LBB3:
	...
	cmp	r3, #0
	beq	.L58
	.loc 2 107 5 is_stmt 0 discriminator 1
	ldr	r2, .L62
	movs	r1, #107
	ldr	r0, [sp, #24]
	bl	app_error_handler
...
.LBB4:
	...
	cmp	r3, #0
	beq	.L60
	.loc 2 120 5 is_stmt 0 discriminator 1
	ldr	r2, .L62
	movs	r1, #120
	ldr	r0, [sp, #20]
	bl	app_error_handler
...
.L62:
	...
	.word	.LC1
.LFE274:
	.size	drv_ADG728_write, .-drv_ADG728_write
	.section .rodata
	.align	2
.LC2:
	.ascii	"\033[1;31mdrv_ADG728   :ERROR:drv_ADG728_read Faile"
	.ascii	"d!\015\012\000"
	.section	.text.drv_ADG728_read,"ax",%progbits
	.align	1
	.global	drv_ADG728_read
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	drv_ADG728_read, %function
drv_ADG728_read:
.LFB275:
	.loc 2 127 1
	@ args = 0, pretend = 0, frame = 24
...
.L69:
	...
	.word	.LC2
.LFE275:
	.size	drv_ADG728_read, .-drv_ADG728_read
...
.Letext0:
	...
	.file 16 "C:\\Nordic\\SDK\\Nordic-Thingy52-FW-XpertRide\\project\\pca20020_s132-XpertRide_v2\\0827.ses\\drv_ADG728.h"
...
.Ldebug_abbrev0:
	...
	.ascii	"m_ADG728\000"
	.4byte	0x1461
	.ascii	"drv_ADG728_read\000"
	.4byte	0x14e5
	.ascii	"drv_ADG728_write\000"
	.4byte	0x1588
	.ascii	"drv_ADG728_init\000"
	.4byte	0x15b8
	.ascii	"twi_close\000"
	.4byte	0x15ce
	.ascii	"twi_open\000"
